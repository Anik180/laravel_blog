                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group form-float">
                           <div class="form-line">
                              <input type="text" id="title" class="form-control" name="title" value="{{$member->title}}">
                     ...
                     <div class="col-md-6">
                        <div class="form-group form-float">
                           <div class="form-line">
                              <input type="text" id="short_title" class="form-control" name="short_title" value="{{$member->short_title}}">
