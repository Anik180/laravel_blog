...
<ol class='breadcrumb' itemscope itemtype='https://schema.org/BreadcrumbList'>
   ...
   <li class='active'>{{$singlepast->title}}</li>
</ol>
...
<div id="post-content">
   ...
   <div class="row">
      <div class="col-md-12 vmargin">
         <h1 class="bold h2">{{$singlepast->title}}</h1>
         <div class="clearfix"></div>
         <div class="clearfix"></div>
      </div>
   </div>
   <div class="alert-secondary btn-block text-center" style="margin-bottom:15px">
      <img class="center-block" alt="Agile and DevOps for the Oracle Cloud" title="Agile and DevOps for the Oracle Cloud" src="{{ url('storage/events/'.$singlepast->image) }}" />
      <div class="clearfix"></div>
   </div>
   <div class="clearfix"></div>
   <div class="row">
      ...
      <div class="well text-center bmargin">
         <div class="row">
            <div class="col-sm-6 xs-bmargin">
               ...
               {{ date("F jS, Y", strtotime($singlepast->start_date)) }} 
            </div>
            <div class="col-sm-6">
               <b> <i class="fa fa-calendar"></i>End date</b> <br>
               {{ date("F jS, Y", strtotime($singlepast->end_date)) }} 
            </div>
         </div>
      </div>
      <div class="the-post-description">
         <p>
         	{!!$singlepast->description!!}
         </p>
         <div class="clearfix"></div>
      </div>
      <div class="clearfix"></div>
