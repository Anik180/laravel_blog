                                    ...
                                    @foreach($categories as $key=>$categories)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.category.edit',$categories->id) }}" class="btn btn-info waves-effect">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <button class="btn btn-danger waves-effect" type="button" onclick="deleteCategories({{ $categories->id }})">
                                                    <i class="material-icons">delete</i>
                                                </button>
                                                <form id="delete-form-{{ $categories->id }}" action="{{ route('admin.category.destroy',$categories->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
